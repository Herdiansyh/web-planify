...
export default function Show({ ...props }) {
  ...
  return (
    <>
      <div>
        <img className="h-32 w-full object-cover lg:h-48" src={workspace.cover} />
      </div>
        ...
        <div className="-mt-12 sm:flex sm:items-center sm:space-x-5">
          ...
          <div className="items-center sm:flex sm:min-w-0 sm:flex-1 sm:justify-end sm:space-x-6 sm:pb-1">
            <div className="mt-6 min-w-0 flex-1">
              <CardTitle className="text-4xl leading-relaxed tracking-tighter">{workspace.name}</CardTitle>
            </div>
            ...
            <div className="w-full space-y-4 sm:w-1/4" key={index}>
              ...
              <div className="flex flex-grow flex-col gap-4 overflow-y-auto overflow-x-hidden p-2">
                {cards
                  ...
                  .map((card, index) => (
                    <Card key={index} className="relative rounded-xl hover:ring-2 hover:ring-inset hover:ring-red-500">
                      <CardHeader>
