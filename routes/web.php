...
Route::controller(WorkspaceController::class)->group(function(){
    ...
    Route::post('workspaces/member/{workspace:slug}/store', 'member_store')
        ->name('workspaces.member_store');
...
Route::controller(CardController::class)->group(function(){
    Route::get('cards/{workspace:slug}/create', 'create')
        ->name('cards.create');
    Route::post('cards/{workspace:slug}/create', 'store')
        ->name('cards.store');
    Route::get('cards/{workspace:slug}/detail/{card}', 'show')
        ->name('cards.show');
    Route::get('cards/{workspace:slug}/edit/{card}', 'edit')
        ->name('cards.edit');
    Route::put('cards/{workspace:slug}/edit/{card}', 'update')
        ->name('cards.update');
    Route::post('cards/{workspace:slug}/{card}/reorder', 'reorder')
        ->name('cards.reorder');
...
Route::controller(MemberCardController::class)->group( function(){
     Route::post('cards/member/{card}/store', 'store')->name('members_card.store');
